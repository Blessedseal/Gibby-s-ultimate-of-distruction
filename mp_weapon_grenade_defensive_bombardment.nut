...
const float DEFENSIVE_BOMBARDMENT_RADIUS 		 	= 60000 //The radius of the bombardment area.
const int	DEFENSIVE_BOMBARDMENT_DENSITY			= 999	//The density of the distributed shell randomness.
const float DEFENSIVE_BOMBARDMENT_DURATION			= 999.0 //The duration the bombardment will last.
const float DEFENSIVE_BOMBARDMENT_DELAY 			= 0.001 //The bombardment will wait 2.0 seconds before firing the first shell.

const float DEFENSIVE_BOMBARDMENT_SHELLSHOCK_DURATION = 1
